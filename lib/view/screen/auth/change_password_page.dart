          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
               ...
               Container(margin: const EdgeInsets.only(bottom: 10),child: const Text(textAlign: TextAlign.center,"New Password",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 22),)),
               const Text(textAlign: TextAlign.center,"Your New Password must be diffrent \n from previously used password",style: TextStyle(color: AppColor.thirdColor)),
const SizedBox(height:50,),
                ...
                CustomButtonAuth(txtBtn: 'Confirm', onPressed: (){
